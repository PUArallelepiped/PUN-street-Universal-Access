<script lang="ts">
	let tagInputData: {
		...
		{ category_id: 2, category_name: 'alocol free' },
		{ category_id: 3, category_name: 'summer' },
		{ category_id: 4, category_name: 'high quality' },
		{ category_id: 5, category_name: 'easy to go and yummy' }
	];
	...
	<div class=" group relative block w-fit text-transparent">
		...
		>
			<div class=" flex w-fit flex-col items-center justify-center gap-1 bg-white p-5 shadow-xl">
				{#each tagInputData as { category_id, category_name }}
