	...
	<div class="flex w-full justify-center">
		<div class="flex w-2/3 pb-32">
			<div class="wrap relative mt-12 flex w-full flex-col items-center justify-center space-y-8">
				<div
					class=" hover:w-144 group peer flex h-40 w-40 justify-between overflow-hidden rounded-xl bg-white p-4 shadow-2xl duration-500 ease-in-out hover:translate-x-0 hover:translate-y-9 hover:scale-125 hover:shadow-zinc-500"
				>
					<img
						src={watermelon}
						alt=""
